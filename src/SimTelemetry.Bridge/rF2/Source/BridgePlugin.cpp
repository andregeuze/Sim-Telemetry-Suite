...
{
	SendScoringInfo(info);

	// Send every vehicle info
	for (long i = 0; i < info.mNumVehicles; ++i)
	{
		SendVehicleScoringInfo(info, i);
	}
}

void BridgePlugin::SendScoringInfo(const ScoringInfoV01 & info)
{
	...
	scoringStream
		...
		// Session info
		<< ",\"gamePhase\":" << static_cast<int>(info.mGamePhase)
		<< ",\"yellowFlagState\":" << static_cast<int>(info.mYellowFlagState)
		<< ",\"sectorFlags\":[" << static_cast<int>(info.mSectorFlag[0]) << "," << static_cast<int>(info.mSectorFlag[1]) << "," << static_cast<int>(info.mSectorFlag[2]) << "]"
		<< ",\"inRealTime\":" << info.mInRealtime
		<< ",\"startLight\":" << static_cast<int>(info.mStartLight)
		<< ",\"numRedLights\":" << static_cast<int>(info.mNumRedLights)
...
void BridgePlugin::SendVehicleScoringInfo(const ScoringInfoV01 & info, long i)
{
	...
	std::ostringstream vehicleStream;
	vehicleStream
		// Opening json tag
		<< "{"
		...
		<< ",\"sector\":" << static_cast<int>(vinfo.mSector)
		<< ",\"finishStatus\":" << static_cast<int>(vinfo.mFinishStatus)
		...
		<< ",\"control\":" << static_cast<int>(vinfo.mControl)
		<< ",\"inPits\":" << vinfo.mInPits
		<< ",\"lapStartET\":" << vinfo.mLapStartET
		<< ",\"place\":" << static_cast<int>(vinfo.mPlace)
